...
public class UpdateProfileWithSpecialCharacters {
    ...
    public void UpdateProfile() throws InterruptedException {
        ...
        // Clear and set new value for Name
        WebElement nameElement = driver.findElement(By.xpath("//*[@id=\"txtName\"]"));
        clearAndSetValue(nameElement, "!@#$%^&*");

        // Clear and set new value for Phone
        WebElement phoneElement = driver.findElement(By.xpath("//*[@id=\"txtPhone\"]"));
        clearAndSetValue(phoneElement, "1111111111");
        ...
        clearAndSetValue(addressElement, "!@!#$$$$$@@!");
    ...
    private void clearAndSetValue(WebElement element, String value) {
        Actions action = new Actions(driver);
        action.keyDown(element, Keys.CONTROL).sendKeys("a").sendKeys(Keys.DELETE).perform();
